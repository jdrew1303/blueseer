...
OutputBaseFilename=blueseer.sqlite.win.v8.0
Compression=lzma
...
Source: "C:\java\jre26\*"; DestDir: "{app}\jre26"; Flags: ignoreversion recursesubdirs createallsubdirs
; NOTE: Don't use "Flags: ignoreversion" on any shared system files

[Icons]
;Name: "{commonprograms}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}" ; WorkingDir: "{app}";
;english
;Name: "{commonprograms}\{#MyAppName}"; components: english; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=en -Duser.country=US -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"
;Name: "{commondesktop}\{#MyAppName}";  components: english; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=en -Duser.country=US -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"
...
;arabic
Name: "{commonprograms}\{#MyAppName}"; components: arabic; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=ar -Duser.country=SA -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"
Name: "{commondesktop}\{#MyAppName}";  components: arabic; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=ar -Duser.country=SA -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"

;chinese
Name: "{commonprograms}\{#MyAppName}"; components: chinese; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=zh -Duser.country=CN -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"
Name: "{commondesktop}\{#MyAppName}";  components: chinese; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=zh -Duser.country=CN -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"

;french
Name: "{commonprograms}\{#MyAppName}"; components: french; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=fr -Duser.country=FR -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"
Name: "{commondesktop}\{#MyAppName}";  components: french; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=fr -Duser.country=FR -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"

;italian
Name: "{commonprograms}\{#MyAppName}"; components: italian; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=it -Duser.country=IT -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"
Name: "{commondesktop}\{#MyAppName}";  components: italian; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=it -Duser.country=IT -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"

;spanish
Name: "{commonprograms}\{#MyAppName}"; components: spanish; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=es -Duser.country=ES -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"
Name: "{commondesktop}\{#MyAppName}";  components: spanish; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=es -Duser.country=ES -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"

;turkish
Name: "{commonprograms}\{#MyAppName}"; components: turkish; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=tr -Duser.country=TR -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"
Name: "{commondesktop}\{#MyAppName}";  components: turkish; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=tr -Duser.country=TR -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"

;german
Name: "{commonprograms}\{#MyAppName}"; components: german; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=de -Duser.country=DE -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"
Name: "{commondesktop}\{#MyAppName}";  components: german; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=de -Duser.country=DE -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"

;romanian
Name: "{commonprograms}\{#MyAppName}"; components: romanian; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=ro -Duser.country=RO -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"
Name: "{commondesktop}\{#MyAppName}";  components: romanian; Filename: "{app}\jre26\bin\javaw.exe"; WorkingDir: "{app}"; Parameters: "-Djava.util.logging.config.file=bslogging.properties -Duser.language=ro -Duser.country=RO -cp dist/* com.blueseer.utl.mf" ; Tasks: desktopicon ; IconFilename: "{app}\images\bs.ico"
